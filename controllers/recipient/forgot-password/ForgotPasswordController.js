import { ForgotPasswordModel } from "../../../models/recipient/forgot-password/ForgotPasswordModel.js";
import { toastService } from "../../../assets/js/utils/ToastService.js";

export class ForgotPasswordRecipientController {
  constructor(
    buttonSendCodeId,
    buttonVerifyCodeId,
    ...
    try {
      ...
      if (validationResult.valid) {
        if (this.model.updatePassword(newPassword)) {
          ...
          window.location.href = "#loginRecipient";
        } else {
